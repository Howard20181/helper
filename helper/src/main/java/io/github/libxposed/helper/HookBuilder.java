...
public interface HookBuilder {
    ...
    interface ExecutableMatcher<Self extends ExecutableMatcher<Self>> extends MemberMatcher<Self> {
         ...
         *             .setName(builder.prefix("Handler"))
         *         )
         *     ))
         * ).onMatch(method -> {
         *     hook(method, MyHooker.class);
         ...
         *         builder.exact(String.class),
         *         builder.exact(int[].class)
         *     ))
         * ).onMatch(method -> {
         *     hook(method, MyHooker.class);
         * });
    ...
    interface ClassMatch extends ReflectMatch<ClassMatch, Class<?>, ClassMatcher> {
        ...
        /**
         * Finds methods in this class matching the specified criteria.
         *
         * <p>This method searches within the already loaded class for methods
         * that match the given criteria. By default, it only searches methods
         * declared in this class. Use {@link MethodMatcher#setIncludeSuper(boolean)}
         * to include inherited methods from superclasses.
         *
         * <p>Example usage:
         * <pre>{@code
         * builder.exactClass("com.example.MyClass").onMatch(clazz -> {
         *     // Find all public methods in this class
         *     clazz.findMethods(m -> m
         *         .setIsPublic(true)
         *     ).onMatch(methods -> {
         *         for (Method method : methods) {
         *             hook(method, MyHooker.class);
         ...
         *     clazz.findMethods(m -> m
         *         .setReturnType(builder.exact(String.class))
         *     ).onMatch(methods -> {
         *         // Process methods...
         *     });
         *
         *     // Find first method with specific name
         *     clazz.findFirstMethod(m -> m
         *         .setName(builder.exact("getData"))
         *         .setParameterCount(0)
         *     ).onMatch(method -> {
         *         hook(method, MyHooker.class);
         *     });
         ...
         */
        @NonNull
        MethodLazySequence findMethods(@NonNull Consumer<MethodMatcher> matcher);

        /**
         * Finds the first method in this class matching the specified criteria.
         *
         * <p>This is more efficient than {@link #findMethods(Consumer)} when you only need
         * one match, as it stops searching after finding the first match.
         *
         * <p>Example usage:
         * <pre>{@code
         ...
         */
        @NonNull
        MethodMatch findFirstMethod(@NonNull Consumer<MethodMatcher> matcher);
        ...
        /**
         * Finds constructors in this class matching the specified criteria.
         *
         * <p>Example usage:
         * <pre>{@code
         * builder.exactClass("com.example.MyClass").onMatch(clazz -> {
         *     // Find all public constructors
         *     clazz.findConstructors(c -> c
         *         .setIsPublic(true)
         *     ).onMatch(constructors -> {
         *         for (Constructor<?> ctor : constructors) {
         *             hook(ctor, MyHooker.class);
         *         }
         *     });
         * });
         * }</pre>
         ...
         */
        @NonNull
        ConstructorLazySequence findConstructors(@NonNull Consumer<ConstructorMatcher> matcher);

        /**
         * Finds the first constructor in this class matching the specified criteria.
         *
         * <p>Example usage:
         * <pre>{@code
         * builder.exactClass("com.example.MyClass").onMatch(clazz -> {
         *     clazz.findFirstConstructor(c -> c
         *         .setParameterCount(1)
         *     ).onMatch(constructor -> {
         *         hook(constructor, MyHooker.class);
         *     });
         * });
         * }</pre>
         *
         ...
         */
        @NonNull
        ConstructorMatch findFirstConstructor(@NonNull Consumer<ConstructorMatcher> matcher);
        ...
        /**
         * Finds fields in this class matching the specified criteria.
         *
         * <p>Example usage:
         * <pre>{@code
         * builder.exactClass("com.example.MyClass").onMatch(clazz -> {
         *     // Find all static fields
         *     clazz.findFields(f -> f
         *         .setIsStatic(true)
         *     ).onMatch(fields -> {
         *         for (Field field : fields) {
         *             log("Found static field: " + field.getName());
         *         }
         *     });
         *
         *     // Find fields of type String
         *     clazz.findFields(f -> f
         *         .setType(builder.exact(String.class))
         *     ).onMatch(fields -> {
         *         // Process fields...
         *     });
         * });
         ...
         */
        @NonNull
        FieldLazySequence findFields(@NonNull Consumer<FieldMatcher> matcher);

        /**
         * Finds the first field in this class matching the specified criteria.
         *
         * <p>Example usage:
         * <pre>{@code
         * builder.exactClass("com.example.MyClass").onMatch(clazz -> {
         *     clazz.findFirstField(f -> f
         *         .setName(builder.exact("mData"))
         *     ).onMatch(field -> {
         ...
         */
        @NonNull
        FieldMatch findFirstField(@NonNull Consumer<FieldMatcher> matcher);
