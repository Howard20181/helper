...
class ClassMatchKt @PublishedApi internal constructor(match: ClassMatch) :
     ...
     * ```
     */
    inline fun findMethods(crossinline matcher: MethodMatcherKt.() -> Unit): MethodLazySequenceKt {
        return MethodLazySequenceKt(match.findMethods { m ->
            MethodMatcherKt(m).matcher()
        })
    }
     ...
     * ```kotlin
     * builder.exactClass("com.example.MyClass").onMatch { clazz ->
     *     clazz.findFirstMethod {
     *         name = builder.exact("getData")
     *         parameterCount = 0
     *     }.onMatch { method ->
     *         hook(method, MyHooker::class.java)
     *     }
     ...
     * ```
     */
    inline fun findFirstMethod(crossinline matcher: MethodMatcherKt.() -> Unit): MethodMatchKt {
        return MethodMatchKt(match.findFirstMethod { m ->
            MethodMatcherKt(m).matcher()
        })
    }
     ...
     * ```kotlin
     * builder.exactClass("com.example.MyClass").onMatch { clazz ->
     *     clazz.findConstructors {
     *         isPublic = true
     *     }.onMatch { constructors ->
     *         constructors.forEach { ctor ->
     *             hook(ctor, MyHooker::class.java)
     *         }
     *     }
     * }
     * ```
     */
    inline fun findConstructors(crossinline matcher: ConstructorMatcherKt.() -> Unit): ConstructorLazySequenceKt {
        return ConstructorLazySequenceKt(match.findConstructors { c ->
            ConstructorMatcherKt(c).matcher()
        })
    }
     ...
     * ```kotlin
     * builder.exactClass("com.example.MyClass").onMatch { clazz ->
     *     clazz.findFirstConstructor {
     *         parameterCount = 1
     *     }.onMatch { constructor ->
     *         hook(constructor, MyHooker::class.java)
     *     }
     * }
     * ```
     */
    inline fun findFirstConstructor(crossinline matcher: ConstructorMatcherKt.() -> Unit): ConstructorMatchKt {
        return ConstructorMatchKt(match.findFirstConstructor { c ->
            ConstructorMatcherKt(c).matcher()
        })
    }
     ...
     *     clazz.findFields {
     *         isStatic = true
     *         type = builder.exact(String::class.java)
     *     }.onMatch { fields ->
     ...
     * ```
     */
    inline fun findFields(crossinline matcher: FieldMatcherKt.() -> Unit): FieldLazySequenceKt {
        return FieldLazySequenceKt(match.findFields { f ->
            FieldMatcherKt(f).matcher()
        })
    }
     ...
     * ```kotlin
     * builder.exactClass("com.example.MyClass").onMatch { clazz ->
     *     clazz.findFirstField {
     *         name = builder.exact("mData")
     *     }.onMatch { field ->
     ...
     * ```
     */
    inline fun findFirstField(crossinline matcher: FieldMatcherKt.() -> Unit): FieldMatchKt {
        return FieldMatchKt(match.findFirstField { f ->
            FieldMatcherKt(f).matcher()
        })
    }
